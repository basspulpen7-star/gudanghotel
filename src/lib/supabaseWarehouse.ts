...
const rawUrl = (
  (typeof import.meta !== 'undefined' && import.meta.env && (import.meta.env.VITE_WAREHOUSE_SUPABASE_URL || import.meta.env.VITE_SUPABASE_URL)) ||
  DEFAULT_WAREHOUSE_URL
).trim();

const rawKey = (
  (typeof import.meta !== 'undefined' && import.meta.env && (import.meta.env.VITE_WAREHOUSE_SUPABASE_ANON_KEY || import.meta.env.VITE_SUPABASE_ANON_KEY)) ||
